...
class LegoModelJdbcTest(@Autowired val legoModelJdbcRepository: LegoModelJdbcRepository, @Autowired val brickJdbcRepository: BrickJdbcRepository) {
    ...
    fun modelReferencingBricks() {
        ...
        val bricks: List<Brick> = brickJdbcRepository.saveAll(listOf(thin2x2, thin2x4, normal2x2)).toList()
        ...
        val legoModel = legoModelJdbcRepository.save(womenOfNasa)

        assertThat(brickJdbcRepository.findAll().toList().size).isEqualTo(3)
